...
using Phd_portal_G1.Data;
using Phd_portal_G1.Models;

namespace Phd_portal_G1.Controllers
{
    public class UserInfosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,UserName,UserEmail,Name,Password,Phone")] UserInfo userInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,UserName,UserEmail,Name,Password,Phone")] UserInfo userInfo)
        {
